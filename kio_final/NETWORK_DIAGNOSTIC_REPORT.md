...
| Test | Status | Detail |
|------|--------|--------|
| TELEGRAM_TOKEN present | PASS | length=46, prefix=8935872380:AAFI... |
| TELEGRAM_TOKEN format (botID:hash) | PASS | token=8935872380:AAFI... |
...
| https://api.telegram.org/bot8935872380:AAFI.../getMe | FAIL | ConnectTimeout:  |
| https://149.154.175.53/bot8935872380:AAFI.../getMe (Host=api.telegram.org) | FAIL | ConnectError:  |
| https://91.108.56.100/bot8935872380:AAFI.../getMe (Host=api.telegram.org) | FAIL | ConnectError:  |
